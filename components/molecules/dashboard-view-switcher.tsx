...
import { MbokaTooltip, MbokaTooltipProvider } from "@/components/molecules/mboka-tooltip";
    ...
    <MbokaTooltipProvider>
      ...
      >
        {views.map((view) => {
          ...
          return (
            <MbokaTooltip key={view.href} label={view.description} side="right" align="start">
              <Link
                href={view.href}
                onClick={onNavigate}
